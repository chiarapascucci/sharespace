"""
    ...
    the classes in this file represent HTML form that are displayed in Django's admin interface
    which allows a super user to manage all data within the app
