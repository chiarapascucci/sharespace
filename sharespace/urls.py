"""
    ...
    this file records all the URLs of the application
    each URL is assigned a "view" function or class which takes care of rendering the right template
    and retrieving the right data to display
    all of the URL path below are preceded by "sharespace/"
