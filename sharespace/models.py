"""
    ...
    this file contains classes that represent database entities for the application
    those classes inherit from django's Model class, which take care of the mapping
    of the python class to a database table
...
# this class sets out the basic for implementing the functionality of having user-create groups within neighbourhoods
# in the future
...
class Item(models.Model):
    ...
    def get_loans_for_month(self, month: int, year: int):
        ...
        print(
            "models - 300 - log: month {}, year {}, first day {}, last day {}".format(month, year, first_day, last_day))
        loan_q_set = self.on_loan.filter(out_date__lte=last_day, due_date__gte=first_day,
                                         status__in=['act', 'fut', 'pen'])
